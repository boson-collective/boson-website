...
function ImageBurst({ src, motionProps, styleOverrides = {} }) {
 ...
 function Projects() {
  ...
  const motionPropsList = bursts.map((b, i) => {
    const dir = i % 4;
    return {
      x: useTransform(b, [0, 0.85, 1], [0, dir % 2 === 0 ? 200 : -200, dir % 2 === 0 ? 240 : -240]),
      y: useTransform(b, [0, 0.85, 1], [0, dir < 2 ? -170 : 170, dir < 2 ? -200 : 200]),
  ...
  const textFilter = useTransform(introProgress, [0, 1], ["blur(20px)", "blur(0px)"]);
