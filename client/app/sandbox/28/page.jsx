...
function Footer() {
  return (
    <div className="footer-section sticky bottom-0 w-full h-screen bg-black text-white overflow-hidden flex items-center px-[80px] z-[1] max-[900px]:relative max-[900px]:h-auto max-[900px]:overflow-visible max-[900px]:block max-[900px]:px-6 max-[900px]:pb-24">
      
      <div className="footer-chrome absolute -left-[10%] top-1/2 -translate-y-1/2 rotate-90 w-[1200px] h-[2000px] opacity-90 max-[900px]:scale-[.55] max-[900px]:-left-[40%] max-[900px]:top-[60%] max-[900px]:opacity-30" />

      <div className="ml-auto w-[62%] grid grid-cols-2 gap-28 max-[900px]:w-full max-[900px]:grid-cols-1 max-[900px]:gap-14">

        <div className="flex flex-col gap-6">
          <h1 className="text-[42px] font-light leading-tight tracking-tight max-w-md max-[900px]:text-[32px] max-[480px]:text-[28px]">
            LET’S WORK TOGETHER
          </h1>

          <p className="text-sm opacity-60 leading-relaxed max-w-xs max-[900px]:max-w-full">
            If your work requires intention, clarity, or engineered precision, this is where the conversation begins.
          </p>

          <a href="mailto:boson.studio@gmail.com" className="text-lg font-light mt-6 inline-flex items-center gap-2 opacity-90 hover:opacity-100">boson.studio@gmail.com →</a>
        </div>
        ...
        <div className="flex flex-col gap-14 text-sm">
          ...
          <div className="flex flex-col gap-6 opacity-75">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1 mt-3">
                {["Design", "Architecture", "Engineering"].map((txt) => (
                  <span key={txt} className="hover:opacity-100 cursor-pointer">{txt}</span>
                ))}
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 opacity-75 mt-4">
              {["Behance", "Dribbble", "LinkedIn", "Medium"].map((txt) => (
                <span key={txt} className="cursor-pointer hover:opacity-100">{txt}</span>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 opacity-75 mt-4">
              {["Home", "Work", "Systems", "Approach", "Contact"].map((item) => (
                <span key={item} className="cursor-pointer hover:opacity-100">{item}</span>
              ))}
            </div>
          </div>
...
/* ==========================================
   ...
   export default function Page() {
    ...
    return (
      ...
      >
        <div
          className="sticky top-0 h-screen z-[1]"
    ...
    //     style={{
    //       width: "100%",
    //       height: "200vh", // perlu tinggi ekstra biar bisa scroll takeover
    //       background: "#000",
    //       position: "relative",
    //       overflow: "hidden",
    //     }}
    //   >
    //     {/* HERO FULLSCREEN DI ATAS */}
    //     <div
    //       className="sticky top-0 h-screen z-[1]"
    //       style={{ position: "sticky", top: 0, zIndex: 1 }}
    //     >
    ...
    //     {/* BOSON NARRATIVE — NAIK MENUTUP HERO */}
    //     <motion.div
    //       style={{
    //         y: narrativeY, 
    //         position: "absolute",
